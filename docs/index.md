---
description: MosaicJS is a framework-agnostic, deterministic drag-and-drop engine for the browser, with constraint validation and automatic rollback.
---
...
### [Core Concepts](./documentation/architecture)
...
- **[Drop Targets](./documentation/drop-targets)** — Explicit drop
  destinations distinct from draggable nodes
- **[Group Containers](./documentation/group-containers)** — Scoping drag
  behavior to a subset of nodes
- **[Drag Handles](./documentation/drag-handles)** — Restricting drag
  initiation to a specific descendant element

### [Styling & Customization](./documentation/css-contract)
...
### [Events & Extension Points](./documentation/drag-lifecycle)
...
### [Advanced Topics](./documentation/snapshot-flow)
...
If you're new to MosaicJS, start with **[Architecture Overview](./documentation/architecture)**
and **[Basic Usage](./tutorials/getting-started)**.  
If you're integrating into an existing system, see **[CSS Class Contract](./documentation/css-contract)** 
and **[Constraints System](./documentation/constraints-design)**.